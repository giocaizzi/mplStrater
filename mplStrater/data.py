...
class StrataFrame:
    ...
    def set_df(self):
        ...
        matrici = self.group_data(self.df,"matrice","lista_matrici")
        pericolosita = self.group_data(self.df,'pericolosita',"lista_pericolo")
        destino = self.group_data(self.df,"smaltibilità_riutilizzo","destino")
        amianto_qual=self.group_data(self.df,"amianto_qualitativa","amianto_qual")
        amianto_quant=self.group_data(self.df,"amianto_quantitativa","amianto_quant")
